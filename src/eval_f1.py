...
if __name__ == "__main__":
    ...
    if pred_labels.index.name != "index":
     ...
     ## Added content
    missing_indices = set(true_labels.index) - set(pred_labels.index)
    extra_indices = set(pred_labels.index) - set(true_labels.index)
    print("Missing indices in predictions:", missing_indices)
    print("Extra indices in predictions:", extra_indices)
    ##
